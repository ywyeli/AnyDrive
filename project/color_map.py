...
def get_colormap() -> Dict[str, Tuple[int, int, int]]:
    ...
    classname_to_color = {  # RGB.
        "None": (0, 0, 0),  # Black.
        "Buildings": (70, 130, 180),  # Steelblue
        "Fences": (0, 0, 230),  # Blue
        "Other": (135, 206, 235),  # Skyblue,
        "Pedestrians": (100, 149, 237),  # Cornflowerblue
        "Poles": (219, 112, 147),  # Palevioletred
        "RoadLines": (0, 0, 128),  # Navy,
        "Roads": (240, 128, 128),  # Lightcoral
        "Sidewalks": (138, 43, 226),  # Blueviolet
        "Vegetation": (112, 128, 144),  # Slategrey
        "Vehicles": (210, 105, 30),  # Chocolate
        "Walls": (105, 105, 105),  # Dimgrey
        "TrafficSigns": (47, 79, 79),  # Darkslategrey
        "Sky": (188, 143, 143),  # Rosybrown
        "Ground": (220, 20, 60),  # Crimson
        "Bridge": (255, 127, 80),  # Coral
        "RailTrack": (255, 69, 0),  # Orangered
        "GuardRail": (255, 158, 0),  # Orange
        "TrafficLight": (233, 150, 70),  # Darksalmon
        "Static": (255, 83, 0),
        "Dynamic": (255, 215, 0),  # Gold
        "Water": (255, 61, 99),  # Red
        "Terrain": (255, 140, 0),  # Darkorange
