...
def main():
    path = '/media/ye/Data/Place3D/carla_nus/dataset/nus/LiDAR_p0_samples/samples/LIDAR_TOP/'
    pcc_path = path + 'n008-2018-08-01-00-00-00-0400__LIDAR_TOP__1500000000000001.pcd.bin'
